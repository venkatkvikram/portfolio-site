  ...
  return (
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
          Building scalable and high-performance applications that drive business growth.
        </motion.p>
      </div>

      {/* IMAGE */}
      <div data-blobity-tooltip="Venkatkvikram">
        <motion.div
          ref={imgRef}
          style={{ rotate }}
        ...
        >
          <Image
            src="/VenkataSai_Logo.png"
            priority
            fill
            alt="Venkat's picture"
            className="px-10 pt-20 object-cover"
          />
        </motion.div>
      </div>
    </section>
