...
export default function FolioCard({
  ...
  return (
    ...
    >
      {img && <Image src={img} width={420} height={700} alt="work" className="rounded-[10px] w-full lg:col-span-5" />}
      <div className="flex flex-col gap-4 lg:col-span-7">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3 md:gap-4 text-2xl sm:text-3xl xl:text-4xl">
            ...
            >
              <Icon icon="mingcute:github-line" className={`${!gitLink && "opacity-30"}`} />
            </Link>
          </div>
        </div>
